...
#include "../infotainment/controller/system.h"
...
void System::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&System::carLockedChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&System::outdoorTempChanged)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&System::userNameChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (System::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&System::currentTimeChanged)) {
                *result = 3;
                return;
            }
        }
