...
#include "../infotainment/controller/hvachandler.h"
...
void HVACHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HVACHandler::targetTemperatureChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject HVACHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HVACHandler.data,
      qt_meta_data_HVACHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HVACHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HVACHandler.stringdata0))
        return static_cast<void*>(const_cast< HVACHandler*>(this));
